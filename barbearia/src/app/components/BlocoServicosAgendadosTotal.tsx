...
export default function BlocoServicosAgendadosTotal() {
  ...
  const buscarTotalServicos = useCallback(async (periodo: Periodo) => {
    setLoading(true);
    try {
  ...
  useEffect(() => {
    buscarTotalServicos(periodo);
  }, [periodo, buscarTotalServicos]);
  ...
  return (
    <section className="bg-white border border-gray-200 rounded-xl p-6 flex flex-col gap-4 min-h-[140px] shadow-md w-full">
      <div className="flex items-center gap-3 mb-2">
        <FaCut className="text-gray-600 text-2xl" />
      ...
      <span className="text-sm text-gray-600 font-semibold uppercase tracking-wide mb-2">Total de Serviços Agendados</span>
