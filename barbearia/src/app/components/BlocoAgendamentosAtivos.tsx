...
export default function BlocoAgendamentosAtivos() {
  ...
  return (
    <section className="bg-white border border-gray-200 rounded-xl p-6 flex flex-col gap-4 min-h-[140px] shadow-md w-full">
      ...
      <span className="text-sm text-gray-600 font-semibold uppercase tracking-wide mb-2">Agendamentos Ativos</span>
